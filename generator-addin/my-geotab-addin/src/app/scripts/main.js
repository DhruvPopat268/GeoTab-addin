...
/**
 * Registering the Add-In under window.myGeotabAddin for Geotab to pick it up via manifest
 */
window.myGeotabAddin = window.myGeotabAddin || {};

window.myGeotabAddin.prayoshaAddIn = function () {
  'use strict';
  ...
  return {
    ...
    blur: function () {
      // Handle cleanup or state saving if needed
    }
  };
}();
